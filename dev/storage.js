...
BlocklyStorage.link = function() {
  ...
  BlocklyStorage.makeRequest_('http://msatellite.info/cauliflower-support/storage.php', 'xml', data);
};
  ...
  if (BlocklyStorage.httpRequest_.readyState == 4) {
    ...
    if (BlocklyStorage.httpRequest_.status != 200) {
      ...
      if (BlocklyStorage.httpRequest_.name == 'xml') {
        ...
        BlocklyStorage.alert(BlocklyStorage.LINK_ALERT, window.location.href);
...
BlocklyStorage.alert = function (text1,text2){
    $("#dialog-message-text1").html(text1);
    $("#dialog-message-text2").html(text2);
