...
Blockly.JavaScript.math_change = function() {
  ...
  var argument0 = Blockly.JavaScript.valueToCode(this, 'DELTA', Blockly.JavaScript.ORDER_ADDITION) ||
  '0';
  var varName = Blockly.JavaScript.variableDB_.getName(this.getTitleText('VAR'), Blockly.Variables.NAME_TYPE);
...
Blockly.JavaScript.math_single = function() {
  ...
  if (operator == 'NEG') {
    ...
    var argument = Blockly.JavaScript.valueToCode(this, 'NUM', Blockly.JavaScript.ORDER_UNARY_NEGATION) ||
    '0';
  ...
  var argNaked = Blockly.JavaScript.valueToCode(this, 'NUM', Blockly.JavaScript.ORDER_NONE) ||
  '0';
  var argParen = Blockly.JavaScript.valueToCode(this, 'NUM', Blockly.JavaScript.ORDER_DIVISION) ||
  '0';
  ...
  case 'ROUNDDOWN':
    ...
    break;
  case 'SIN':
    code = 'Math.sin(' + argParen + ')';
    //code = 'Math.sin(' + argParen + ' / 180 * Math.PI)';//オリジナル
    break;
  case 'COS':
    code = 'Math.cos(' + argParen + ')';
    //code = 'Math.cos(' + argParen + ' / 180 * Math.PI)';
    break;
  case 'TAN':
    code = 'Math.tan(' + argParen + ')';
...
Blockly.JavaScript.math_double = function() {
  var valueA = Blockly.JavaScript.valueToCode(this, 'A', Blockly.JavaScript.ORDER_COMMA) || '0';
  var valueB = Blockly.JavaScript.valueToCode(this, 'B', Blockly.JavaScript.ORDER_COMMA) || '0';
  var code = '';
  var operator = this.getTitleValue('OP');
  switch (operator) {
  case 'MAX':
    code = 'Math.max(' + valueA + ', ' + valueB + ')';
    break;
  case 'MIN':
    code = 'Math.min(' + valueA + ', ' + valueB + ')';
    break;
  default:
...
Blockly.JavaScript.math_const = function() {
...
Blockly.JavaScript.math_on_list = function() {
  ...
  switch (func) {
  case 'SUM':
    list = Blockly.JavaScript.valueToCode(this, 'LIST', Blockly.JavaScript.ORDER_MEMBER) ||
    '[]';
    code = list + '.reduce(function(x, y) {return x + y;})';
    break;
  case 'MIN':
    list = Blockly.JavaScript.valueToCode(this, 'LIST', Blockly.JavaScript.ORDER_COMMA) ||
    '[]';
  ...
  case 'AVERAGE':
    ...
    if (!Blockly.JavaScript.definitions_['math_mean']) {
      var functionName = Blockly.JavaScript.variableDB_.getDistinctName('math_mean', Blockly.Generator.NAME_TYPE);
    ...
    list = Blockly.JavaScript.valueToCode(this, 'LIST', Blockly.JavaScript.ORDER_NONE) ||
    '[]';
  ...
  case 'MEDIAN':
    ...
    if (!Blockly.JavaScript.definitions_['math_median']) {
      var functionName = Blockly.JavaScript.variableDB_.getDistinctName('math_median', Blockly.Generator.NAME_TYPE);
  ...
  case 'MODE':
    if (!Blockly.JavaScript.definitions_['math_modes']) {
      var functionName = Blockly.JavaScript.variableDB_.getDistinctName('math_modes', Blockly.Generator.NAME_TYPE);
  ...
  case 'STD_DEV':
    if (!Blockly.JavaScript.definitions_['math_standard_deviation']) {
      var functionName = Blockly.JavaScript.variableDB_.getDistinctName('math_standard_deviation', Blockly.Generator.NAME_TYPE);
  ...
  case 'RANDOM':
    if (!Blockly.JavaScript.definitions_['math_random_item']) {
      var functionName = Blockly.JavaScript.variableDB_.getDistinctName('math_random_item', Blockly.Generator.NAME_TYPE);
...
Blockly.JavaScript.math_constrain = function() {
  ...
  var argument0 = Blockly.JavaScript.valueToCode(this, 'VALUE', Blockly.JavaScript.ORDER_COMMA) ||
  '0';
  var argument1 = Blockly.JavaScript.valueToCode(this, 'LOW', Blockly.JavaScript.ORDER_COMMA) ||
  '0';
  var argument2 = Blockly.JavaScript.valueToCode(this, 'HIGH', Blockly.JavaScript.ORDER_COMMA) ||
  '0';
...
Blockly.JavaScript.math_modulo = function() {
  ...
  var argument0 = Blockly.JavaScript.valueToCode(this, 'DIVIDEND', Blockly.JavaScript.ORDER_MODULUS) ||
  '0';
  var argument1 = Blockly.JavaScript.valueToCode(this, 'DIVISOR', Blockly.JavaScript.ORDER_MODULUS) ||
  '0';
...
Blockly.JavaScript.math_random_int = function() {
  ...
  var argument0 = Blockly.JavaScript.valueToCode(this, 'FROM', Blockly.JavaScript.ORDER_COMMA) ||
  '0';
  var argument1 = Blockly.JavaScript.valueToCode(this, 'TO', Blockly.JavaScript.ORDER_COMMA) ||
  '0';
  if (!Blockly.JavaScript.definitions_['math_random_int']) {
    var functionName = Blockly.JavaScript.variableDB_.getDistinctName('math_random_int', Blockly.Generator.NAME_TYPE);
